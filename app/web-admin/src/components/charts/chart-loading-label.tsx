...
// Registry shipped this as "../components/shimmering-text", which from inside
// components/charts/ resolves to components/components/. The file lands at
// components/shimmering-text.tsx, so the path is one level up, not two.
